...
int packfs_dynamic_scan_archive(const char* packfs_archive_filename, const char* prefix);
int packfs_dynamic_scan_listing(const char* packfs_listing_filename, const char* prefix, const char* prefix_archive);
int packfs_dynamic_scan_archive_dir(const char* path_normalized, const char* prefix);
int packfs_dynamic_scan_path(const char* input_path);
